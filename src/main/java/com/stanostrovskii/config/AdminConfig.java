	...
	public CommandLineRunner loadAdministrators(AdminRepository repo) {
		return new CommandLineRunner() {
			...
			public void run(String... args) {
				try {
					repo.save(new Admin("Stan", "Ostrovskii", "admin1",
							"$2a$10$5kCrzm.hQBEmtBheogcxEutW2bgbfS4WsOBlrXSAKIng..cVVQ.Hm", "stan_ostr@yahoo.com"));
					repo.save(new Admin("Silky", "Ostrovskii", "admin2",
							"$2a$10$tOnY8XNzq1T2CFIuHqQE5eN1ul/FXaBVtFdesFDY8M5MVeQ6rojUe", "stan_ostr@yahoo.com"));
				} catch (Exception e) {
